package com.tecnologias.uniagustapp.adaptadores;
...
import com.tecnologias.uniagustapp.clases.PersonajeVo;
...
public class DirectorioAdapter extends RecyclerView.Adapter<DirectorioAdapter.PersonajeViewHolder>{

    ArrayList<PersonajeVo> listaPersonaje;

    public DirectorioAdapter(ArrayList<PersonajeVo> listaPersonaje) {
