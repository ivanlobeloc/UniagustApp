 ...
 */
public class Fragment_Mweb extends Fragment {


    public Fragment_Mweb() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_mweb, container, false);

        WebView view=(WebView) v.findViewById(R.id.wv_mweb);
        ...
        if (isOnline(getActivity())) {
            String url="http://intraweb.uniagustiniana.edu.co/";
            view.loadUrl(url);
