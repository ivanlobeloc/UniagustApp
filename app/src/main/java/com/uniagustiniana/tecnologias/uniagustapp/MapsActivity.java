...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    */
//https://www.youtube.com/watch?v=nybRpw2H7gg
    @Override
    public void onMapReady(GoogleMap googleMap) {
        ...
        //mMap.addMarker(new MarkerOptions().position(sydney).title("Soy Ivan").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_BLUE)));
        //float zoomlevel = 16;
